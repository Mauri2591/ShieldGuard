            ...
            <div class="content-wrapper">
                <section class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h5 style="font-family: monospace; color:#2d438b; font-weight:bold"><?php echo $_SESSION['empresa_nombre'] ?></h5>
                            </div>
                        </div>
                    </div>
                </section>
                    ...
                    <div class="card">
                        ...
                        <div class="row">
                            <div class="col-md-4 col-sm-6 col-12">
                                <div class="info-box">
                                    <span type="button" id="btn_mis_usuarios_empresa" data-toggle="tooltip" data-placement="top" title="Consultar Usuarios" class="info-box-icon bg-primary"><i class="far fa-user"></i></span>

                                    <div class="info-box-content">
                                        <span class="info-box-text">Mis Usuarios</span>
                                        <span id="lbl_consultar_total_usuarios" class="info-box-number"></span>
                                    </div>
                                </div>
                                <!-- /.info-box -->
                            </div>
                            ...
                            <div class="col-md-4 col-sm-6 col-12">
                                <div class="info-box">
                                    ...
                                    <div class="info-box-content">
                                        <span class="info-box-text">Altas de Usuarios</span>
                            ...
                            <div class="col-md-4 col-sm-6 col-12">
                                <div class="info-box">
                                    <span class="info-box-icon bg-danger"><i class="far fa-arrow-alt-circle-down"></i></span>

                                    <div class="info-box-content">
                                        <span class="info-box-text">Bajas de Usuarios</span>
