    ...
    <body class="hold-transition sidebar-mini">
        ...
        <div class="wrapper">
            ...
            <?php if ($_SESSION['root_id'] === 1) { ?>
                ...
                <div class="content-wrapper">
                    <section class="content-header">
                        <div class="container-fluid">
                            <div class="row mb-2">
                                <div class="col-sm-6">
                                    <h5 style="font-family: monospace; color:#2d438b; font-weight:bold">Mis Partners</h5>
                                </div>
                            </div>

                            <?php if ($_SESSION['rol_id'] === 1) : ?>
                                <button id="btn_alta_empresa" type="button" class="btn btn-info btn-xs">Nuevo Partner +</button>
                                <button id="btn_ver_logs_actividad_partner" type="button" data-toggle="tooltip" data-placement="top" title="Ver Actividades" class="btn btn-info btn-xs"><i class="fas fa-eye"></i></button> <?php else : ?>
                            <?php endif; ?>
                        ...
                        <div class="card">
                            ...
                            <div class="container p-2 bg-light">
                                <div class="container-fluid border p-2">
                                    <table id="table_consultar_partners">
                ...
                <?php
                require_once './Modal_nuevo_partner/mdlNuevoPartner.php';
                require_once './Modal_nuevo_partner/MdlLogsPartners/mdlLogsEventosPartners.php';
                ?>
            <?php } else { ?>
                <!-- Main Sidebar Container -->
                <aside class="main-sidebar sidebar-dark-primary elevation-4" style="background-color: #203b99">
        ...
        ?>
        <script src="consultar_partners.js"></script>
        <script src="Modal_nuevo_partner/MdlLogsPartners/mdlLogsEventosPartners.js"></script>