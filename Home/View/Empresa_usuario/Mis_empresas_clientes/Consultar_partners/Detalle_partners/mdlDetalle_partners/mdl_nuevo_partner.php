<div class="modal fade" id="mdlAltaPartner">
    <div class="modal-dialog">
        <div class="modal-content border-dark">
            <div class="modal-header">
                <h5 class="modal-title text-secondary" style="font-family: monospace; font-weight: bold;"> Dar de Alta Usuario Partner <i class="far fa-user-circle text-info"> +</i> </h5>
