...
if (isset($_SESSION['usuario_empresa_id']) && !empty($_SESSION['usuario_empresa_id'])) {
    ...
    //     $empresa_id = urldecode(openssl_decrypt($_GET['empresa_id'],AES,KEY));
    // }
...
?>
    ...
    <body class="hold-transition sidebar-mini">
            ...
            <div class="content-wrapper">
                <section class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h4 id="nombre_partner">Nuestros Partners</h4>
                            </div>
                        </div>
                    </div>
                </section>
                        ...
                        <div class="row">
                            <div class="col-md-4 col-sm-6 col-12">
                                <div class="info-box  bg-light">
                                    <span type="button" onclick="btn_consultar_partners($('#valor_empresa_id').val())" data-toggle="tooltip" data-placement="top" title="Agregar Usuario" class="info-box-icon bg-primary"><i class="fas fa-user-plus"></i></span>

                                    <div class="info-box-content">
                                        <span>Total Usuarios</span>
                                        <span id="lbl_total_usuarios_partners"></span>
                                    </div>
                                </div>
                                <!-- /.info-box -->
                            </div>
        ...
        include_once './mdlDetalle_partners/mdl_nuevo_partner.php';
    } else {
        ...
        <script>
            ...
            let valor_empresa_id_openssl_decode = <?php echo urldecode(openssl_decrypt($_GET['empresa_id'], AES, KEY)); ?>;

            let url_search = window.location.search;
            let get_param = new URLSearchParams(url_search);
            let param = get_param.get("empresa_id");
            ...
            $(document).ready(function() {
                $.post("../../../../../Controller/ctrEmpresa.php?empre=get_datos_empresa", {
                    ...
                    function(data, textStatus, jqXHR) {
                        document.getElementById("nombre_partner").innerText = "Partner - " + data.empresa_nombre;
                        document.getElementById("lbl_total_usuarios_partners").innerText = data.total_usuarios;
                    },
                    "json"
                );
            });

            function btn_consultar_partners() {
                window.location.href = url + "/Home/View/Empresa_usuario/Mis_empresas_clientes/Consultar_partners/Detalle_partners/vista_usuarios_partners.php?empresa_id=" + param;
            }
        </script>