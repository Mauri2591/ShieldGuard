...
?>
    ...
    <body class="hold-transition sidebar-mini">
        ...
        <div class="wrapper">
                ...
                <div class="col-md-12">
                    <div class="card ">
                        <div class="card-header bg-light border-secondary">
                            <h5 class="card-title"><span class="badge bg-primary border"><span class="text-light">Activos</span< /span>
                            </h5>
                            ...
                            <div class="card-tools">
                                <div class="btn-group">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right bg-primary" role="menu">
                                        <a type="button" onclick="alta_cuenta(<?php echo urldecode(openssl_decrypt($_GET['cliente'], AES, KEY)) ?>)" class="dropdown-item text-primary">Alta de Cuenta</a>
                                        <a type="button" onclick="alta_ip(<?php echo urldecode(openssl_decrypt($_GET['cliente'], AES, KEY)) ?>)" class="dropdown-item text-primary">Alta de Ip's</a>
                                        <a type="button" onclick="alta_url(<?php echo urldecode(openssl_decrypt($_GET['cliente'], AES, KEY)) ?>)" class="dropdown-item text-primary">Alta de Url's</a>
                                    </div>
                                </div>
                                    ...
                                    <div class="card card-primary card-tabs">
                                        <div class="card-header p-0 pt-1">
                                            <ul class="nav nav-tabs" style="height: 1.9em;" id="custom-tabs-one-tab" role="tablist">
                                                <li class="nav-item">
                                                    <a class="nav-link active mt-1 ml-2 mr-1 pt-0 pb-0 pl-1 pr-1" id="custom-tabs-one-home-tab" data-toggle="pill" href="#activos_cliente_nav_cuentas_cliente" role="tab" aria-controls="custom-tabs-one-home" aria-selected="true">Cuentas</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link mt-1 mr-1 pt-0 pb-0 pl-1 pr-1" id="custom-tabs-one-profile-tab" data-toggle="pill" href="#activos_cliente_nav_ips" role="tab" aria-controls="custom-tabs-one-profile" aria-selected="false">Ip's</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link mt-1 mr-1 pt-0 pb-0 pl-1 pr-1" id="custom-tabs-one-messages-tab" data-toggle="pill" href="#activos_cliente_nav_urls" role="tab" aria-controls="custom-tabs-one-messages" aria-selected="false">Url's</a>
                                                </li>
                                        ...
                                        <div class="card-body">
                                            <div class="tab-content" id="custom-tabs-one-tabContent">
                                                <div class="tab-pane fade show active" id="activos_cliente_nav_cuentas_cliente" role="tabpanel" aria-labelledby="custom-tabs-one-home-tab">
                                                    <table id="usuarios_cliente" style="justify-content: center; font-size: 13px; width: 100%;">
                                                        <thead>
                                                            <tr>
                                                ...
                                                <div class="tab-pane fade" id="activos_cliente_nav_ips" role="tabpanel" aria-labelledby="custom-tabs-one-profile-tab">
                                                    <table id="ips_activos_cliente" style="justify-content: center; font-size: 13px; width:100%;">
                                                        <thead style="text-align: center;">
                                                            <tr>
                                                                <th style="width: 70%;">Ip's</th>
                                                ...
                                                <div class="tab-pane fade" id="activos_cliente_nav_urls" role="tabpanel" aria-labelledby="custom-tabs-one-messages-tab">
                                                    <table id="urls_activos_cliente" style="justify-content: center; font-size: 13px; width: 100%;">
                                                        <thead style="text-align: center;">
                                                            <tr>
            ...
            <?php
            require_once './Modales_activos/mdlActivos.php';
            ...
            <script>
                ...
                $(document).ready(function() {
                    ...
                    tabla = $("#ips_activos_cliente").DataTable({
                        "aProcessing": true,
                        "aServerSide": true,
                        dom: 'Bfrtip',
                        "searching": false,
                    ...
                    tabla = $("#urls_activos_cliente").DataTable({
                        "aProcessing": true,
                        "aServerSide": true,
                        dom: 'Bfrtip',
                        "searching": false,
                ...
                function alta_ip(cliente_id) {
                    $("#ip").val('');
                    $.post("../../../../../../Controller/ctrActivos.php?activo=get_ambientes",
                        function(data, textStatus, jqXHR) {
                            document.getElementById("ambiente_ips").innerHTML = data;
                        },
                        "html"
                    );
                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                if (response.status === "error") {
                                    ...
                                    $("#ips_activos_cliente").DataTable().ajax.reload();
                ...
                function alta_url(cliente_id) {
                    $.post("../../../../../../Controller/ctrActivos.php?activo=get_ambientes",
                        function(data, textStatus, jqXHR) {
                            document.getElementById("ambiente_urls").innerHTML = data;
                        },
                        "html"
                    );
                    $("#url").val('');
                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                if (response.status === "error") {
                                    ...
                                    $("#urls_activos_cliente").DataTable().ajax.reload();
                                }
                            },
                            error: function(e) {
                                (e);
