                ...
                <div class="col-md-12">
                    <div class="card ">
                        <div class="card-header bg-light border-secondary">
                            <h5 class="card-title">Soc Lite</h5>
                            ...
                            <div class="card-tools">
                                <div class="btn-group">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right bg-primary" role="menu">
                                        <a type="button" onclick="alta_servicio_soc(<?php echo urldecode(openssl_decrypt($_GET['cliente'], AES, KEY)) ?>)" class="dropdown-item text-primary">Alta de Soc</a>
                                    </div>
                                </div>
